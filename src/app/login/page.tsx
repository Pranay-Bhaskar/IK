    ...
    <html lang="en">
      <body className="min-h-dvh bg-[#12141a] text-white overflow-x-hidden">
        <AuthProvider>
          ...
          {/* Main Container with background image from the public folder */}
          <div 
            className="mx-auto min-h-dvh w-full max-w-[430px] overflow-hidden relative shadow-2xl"
            style={{
          ...
          >
            {/* Ambient dark overlay so your text is always readable */}
            <div className="absolute inset-0 bg-black/50 pointer-events-none z-0" />
            
            {/* Your pages load here, above the background */}
