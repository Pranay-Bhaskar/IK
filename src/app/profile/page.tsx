...
export default function ProfilePage() {
  ...
  // ADDED: State to hold the dynamic Explorer stats
  ...
  // ADDED: Fetch actual Explorer stats from your database
  useEffect(() => {
      ...
      const fetchStats = async () => {
        try {
          ...
          setExplorerStats({
            ...
            explored: 0 // Keep at 0 until you build an "explored" tracking endpoint
          });
        } catch (err) {
    ...
    <div className="min-h-dvh bg-transparent pb-28 relative">
      ...
      <div className="relative z-10">
        ...
        <div className="relative px-4 pt-14 pb-0 overflow-hidden">
          ...
          {/* UPDATED: Dynamic numbers injected from the new state variable */}
          {user.role === "EXPLORER" && (
            <div className="grid grid-cols-3 gap-2 mb-5">
