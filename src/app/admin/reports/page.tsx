  ...
  return (
    <div className="px-4 pt-5 pb-6">
      ...
      <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-4 mb-5 shadow-lg">
        ...
        {/* Improved banner */}
        <div className="mt-4 flex items-center gap-2 bg-white/10 border border-white/10 rounded-xl px-3 py-2">
      ...
      <div className="space-y-2 mb-6">
        {MOCK_REPORTS.map(r => (
          <div
            key={r.id}
            className="bg-black/40 backdrop-blur-md border border-white/10 shadow-lg rounded-2xl p-4 transition-all hover:bg-black/50"
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={cn(
                    "text-[9px] font-black px-2 py-0.5 rounded-full border flex-shrink-0 tracking-wider",
                    r.severity === "high"
            ...
            <div className="flex gap-2 mt-3 pt-3 border-t border-white/10">
              <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-white border border-white text-xs font-bold text-black active:opacity-70 transition-colors shadow-md">
                <CheckCircle2 className="w-3.5 h-3.5" />
                Resolve
              </button>
              <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs font-bold text-white hover:bg-white/10 active:opacity-70 transition-colors">
                Review content
              </button>
            </div>
          </div>
